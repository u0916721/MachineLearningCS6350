...
def runTest(depth, ID3Function, ID3FunctionName):
    ...
    print("Using ID3 Method " + ID3FunctionName + " For depth of " + str(depth) + " Total correct guesses is " + str(totalRight) + " out of " + str(len(testData)) + " Percent is " + str((totalRight/len(testData)) * 100))
